# ELEMENTS DE DIAGNOSTIC ET ENJEUX POUR L'ANCRAGE DE L'ACTIVITE CINEMA DANS LA METROPOLEAIX-MARSEILLE-PROVENCE  
...
Le secteur du cinéma peut ainsi étre découpe en sous-secteurs, ou phases de création :  

La premiere phase est celle qui permet le developpement de Iidee:elaboration du concept et écriture du scenario;   
La phase de financement est tresimportante:elle permet de trouver les fonds pour donner vie au concept développe. Les financeurs peuvent aussi bien appartenir a la sphere publique qu'alasphereprivee ou associative;   
La phase de préproduction consiste a organiser le futur tournage, a trouver le ou les lieux ou il se deroulera;   
La production est ensuite au coeur des projets audiovisuels et cinematographiques, a l'interface entre création et promotion. C'est pendant cette phase de production que le secteur est le plus visible sur le territoire, tant dans I'espace que dans les impacts, notamment économique, qu'il genere : nombre d'emplois et d'intermittents important, location de matériel, tournage dans un studio, présence dans l'espace public, consommation de I'équipe de tournage, sous-traitance via les entreprises locales... i La post-production consiste a traiter ensuite les ceuvres par différentes techniques : montage, étalonnage, mixage, doublage, sous-titrage, effets speciaux...   
La reproduction, Iédition, la distribution et la diffusion constituent les derniers maillons de la chaine de valeur et concernent la promotion et la communication des ceuvres ;   
Enfin, les entreprises dédiees a la fabrication de materiels et les prestataires techniques n'apparaissent pas specifiquement dans la chaine de valeur, mais elles interviennent en tant que soutien a la création et la réalisation de I'ceuvre.Ce sont des activités de fabrication, de reparation, d'installation et de location de materiels électroniques, magnetiques, optiques et photographiques, les activités des agences artistiques et de placement de main-d'ceuvre mais aussi les prestations de services techniques pour le son, I'éclairage, le montage des structures,laprojection,lescostumes.  

Dans le tableau ci-contre, chacune des phases est associé a des metiers/competences. Il permet également de mieux cerner les ancrages territoriaux qui s'operent en fonction de I'étape de production et les leviers possibles pour renforcer cet ancrage, leviers qui seront ensuite developpes dans la suite de cette note.  

<html><body><table><tr><td>Phase</td><td>Ecriturel scenario</td><td>Financement</td><td>Pre- production/ preparation Realisation</td><td>Production/ realisation de l'ceuvre Realisation</td><td>Post-prod/ montagel traitement Realisation</td><td>Commerciali- sation</td><td>Consommation/ diffusion</td></tr><tr><td>Principaux metiers/ postes Pour chaque poste, il peut y avoir plusieurs metiers associes avec des niveaux de responsabilite plusoumoins importants: ·Directeur ·Superviseur, coordinateur ·Technicien ·Assistant ·Operateur/ executeur</td><td>Scenariste/ ecriture Coscenariste Relecture Script doctor Dialoguiste</td><td>Production Chaines de TV Distributeur CNC Sofica Aides regionales Banques...</td><td>(realisateur, assistants...) Production Direction de casting Repereur</td><td>Production executive Acteurset figurants Metiers techniques: ·Image (photo, effets speciaux, cameraman, cadreur,...) ·Son (perchman, ingenieur du son, ...) ·Scripte ·Regie ·Story boarder ·Décor (conception et fabrication, design) · Accessoires (habillage, maquillage, coiffure) ·Systeme, reseauet maintenance</td><td>Coordination post prod Metiers techniques : ·Image (monteur, animation, effetvisuel numerique,3D, infographie, stereographie, etc.) ·Son (bruiteur, compositeur BO, monteur son, ingenieur son, etc.) · Etalonneur</td><td>Distribution (gestion des droits, promotion et negociation... ） Communicati on Critique Exploitation</td><td>Salle de cinema Video TV (Edition et diffusions de chaines) Plateformes Redaction Journalisme Reproduction</td></tr><tr><td>Impactet ancragesurle territoire</td><td>Peu car pas de competences au niveau local</td><td>Aides, notamment regionales, selon certains criteresdontle recoursa des competences enlocal Sinon,pas d'ancragelocal au niveau des financements</td><td>Competences des équipes d'organisation auniveaulocal avec tout leur reseau en appui sur la suite de la production</td><td>Studios, tournage exterieurettout lécosysteme de production Consommation de'équipe de tournage (hotellerie, restauration, location...)</td><td>Entreprises presentessurle territoire</td><td>Peu</td><td>Presence de cinemas, de centre de conservation</td></tr><tr><td>Leviers pour soutenirle secteur</td><td>Formation dediee au metier de scenariste</td><td>Formation pour repondre auxbesoins techniques et de competences au niveaulocal</td><td>Importance de mettre en avantle territoire + un lieu unique (type guichet) pourmettre en évidence l'ecosysteme Soutien aux projets en cours (studios...)</td><td>Soutien des entreprisesetde ces metiers: formation, creation delieu d'innovation, soutien aussi a l'ecosysteme existant</td><td>Soutien deces entrepriseset de ces metiers: formation, creation de lieu d'innovation, attirerles talents</td><td></td><td>Evenements type festival du film, du court metrage...</td></tr></table></body></html>

Competences dans le cinema et I'audiovisuel en fonction de la phase de production, impact et leviersd'ancragepourleterritoire,productionAGAM  
...
Cette explosion des plateformes et des series posent également la question du modele économique cinématographique. Une série va par exemple monopoliser un espace plus longtemps qu'un film, avec possibilité de renouvellement et donc de retour dans les memes lieux, ayant pour conséquence  
...
?our réaliser cette analysé économique, les ICC ont éte repartis en 2 sous catégories :  
...
Nombre et repartition des ESP dans le cinema et I'audiovisuel en 2021 (Acoss)2:   
...
Parmi les metiers techniques manquant dans I'écosysteme metropolitain se trouvent celui de scenariste, qui intervient dans la premiere phase de production cinema, et notamment ceux specialises dans I'écriture de series pour repondre pleinement aux besoins actuels.  
...
Repartition des couts de productions des films de fiction en 2022 $(\%)$  
...
Cette diversite permet a Marseille de se classer deuxieme ville de France en jours de tournage. Elle a comptabilise 493 tournages en 2021 pour 1 434 jours de tournage répartis en 13 longs-metrages, 11 fictions TV (series et téléfilms) et 86 publicités.  
...
![](images/42faaf1c581fd2f81e29a624e32d684d02057ed34ebaec8d959efbfda90e7fa7.jpg)  
